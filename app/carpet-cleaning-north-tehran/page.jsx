...
export const metadata = {
  ...
  description:
    'قالیشویی زارع با پوشش کامل در مناطق شمال تهران مثل تجریش، زعفرانیه، نیاوران، فرمانیه و دارآباد. خدمات تخصصی شستشوی فرش دستبافت و ابریشم.',
  alternates: {
...
const schemaData = {
  ...
  description:
    'قالیشویی زارع با سرویس‌دهی سریع در شمال تهران شامل محله‌هایی مانند تجریش، زعفرانیه، ولنجک، نیاوران، فرمانیه، قیطریه، سوهانک، دارآباد و سایر محله‌های شمیران، خدمات شستشوی فرش دستبافت و گل‌ابریشم را با کیفیت تضمینی ارائه می‌دهد.',
};
