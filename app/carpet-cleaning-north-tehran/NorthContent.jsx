...
const services = [
  ...
  },
  {
    ...
    text: "فرش‌های گل‌ابریشم و تمام‌ابریشم به دلیل حساسیت بافت و رنگ، پس از کارشناسی و با فرایند کنترل‌شده شسته می‌شوند.",
...
const faqData = [
  ...
  },
  {
    ...
    text: "بله، فرش‌های دستباف، پشمی، کرکی، گل‌ابریشم و تمام‌ابریشم پس از بررسی و با روش متناسب با جنس، رنگ و وضعیت بافت شسته می‌شوند.",
  },
  {
