    ...
    <div className="page-content">
      ...
      <section className="why-wash-section">
        ...
        <div className="features">
          <div className="feature">
            <img src="/icons/1.webp" alt="حفظ کیفیت فرش" />
          ...
          <div className="feature">
            <img src="/icons/2.webp" alt="کاهش خطر آسیب" />
          ...
          <div className="feature">
            <img src="/icons/3.webp" alt="افزایش طول عمر فرش" />
      ...
      <section className="wash-process">
        ...
        <div className="process-steps">
          ...
          <div className="step">
            <img src="/icons/cleaning.webp" alt="شستشو با شوینده" />
          ...
          <div className="step">
            <img src="/icons/final-inspection.webp" alt="کنترل نهایی" />
            <h3>کنترل نهایی</h3>
            <p>بررسی نهایی برای اطمینان از کیفیت شستشو و عدم آسیب.</p>
          </div>
          <div className="step">
            <img src="/icons/delivery.webp" alt="تحویل نهایی" />
