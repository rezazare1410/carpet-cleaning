// app/machine-carpet-wash/page.jsx
import '../../styles/MachineCarpetWash.css';
import Link from 'next/link';

export const metadata = {
  title: 'شستشوی فرش ماشینی | قالیشویی زارع',
  description: 'شستشوی تخصصی فرش ماشینی با دستگاه‌های پیشرفته و مواد شوینده مناسب، بدون آسیب به رنگ و بافت فرش.',
};
      ...
      <section className="why-wash-section">
        ...
        <div className="features">
          ...
          <div className="feature">
            ...
            <p>با استفاده از روش‌های مکانیزه و کنترل‌شده، از تغییر شکل، جمع‌شدگی یا آسیب‌های احتمالی به فرش جلوگیری می‌شود.
