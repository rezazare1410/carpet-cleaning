...
const permanentBlogRedirects = new Map([
  ...
  [
    "قالیشویی-شمال-تهران",
    {
      ...
      description:
        "سرویس تخصصی قالیشویی زارع در شمال تهران برای شستشوی کنترل‌شده فرش‌های دستبافت، گل‌ ابریشم، همراه با کارشناسی پیش از شستشو، لکه‌برداری، رفوگری و دریافت و تحویل از محل.",
    },
  ],
]);
