    ...
    <main className="tehran-no-page" dir="rtl">
      ...
      <section className="tehran-no-hero">
        ...
        <aside className="tehran-no-service-card">
          ...
          <p>
            خیابان دماوند، فلکه اطلاعات، میدان امامت، فلکه آشتیانی، حافظیه، خیابان خاقانی، خیابان بلال حبشی، خیابان سفیدکوه، مسیل منوچهری، مسیل جاجرود، خیابان بصیر، خیابان شمس، خیابان ابوریحان، فلکه لوزی، محله
