...
const faqItems = [
  ...
  answer:
  "بله. فرش‌های دستبافت پشمی، کرک و گل‌ابریشم پیش از شستشو از نظر ثبات رنگ، جنس الیاف و آسیب‌های احتمالی بررسی می‌شوند.",
  },
  {
...
export default function TehranNoContent() {
  ...
  پشمی، کرک و گل‌ابریشم، لکه‌برداری و خدمات تخصصی
  ترمیم و رفوگری است.
</p>
        ...
        <aside className="tehran-no-service-card">
          ...
          <p>
            خیابان دماوند، فلکه اطلاعات، میدان امامت، فلکه آشتیانی، حافظیه، خیابان خاقانی، خیابان بلال حبشی، خیابان سفیدکوه، مسیل منوچهری، مسیل جاجرود، خیابان بصیر، خیابان شمس، خیابان ابوریحان، فلکه لوزی، خیابان سعدی،  محله
  ...
  و خدمات موردنیاز محاسبه می‌شود. تعرفه شستشوی فرش
  ماشینی، دستبافت پشمی، کرک و گل‌ابریشم یکسان نیست؛
  زیرا حساسیت الیاف و روش شستشوی آن‌ها متفاوت است.
</p>
