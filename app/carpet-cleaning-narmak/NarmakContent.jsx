...
const services = [
  ...
  },
  {
    ...
    description:
      "شستشوی فرش‌های گل‌ ابریشم با توجه به حساسیت رنگ و ساختار ظریف الیاف انجام می‌شود.",
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "بله. فرش‌های دستبافت پشمی، کرکی، گل‌ ابریشم پیش از شستشو از نظر ثبات رنگ و آسیب‌های احتمالی بررسی می‌شوند.",
  },
  {
    question:
