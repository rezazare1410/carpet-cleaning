...
const pageTitle =
  "قالیشویی در نارمک | شستشوی مکانیزه و رفوگری فرش‌های دستبافت";

const pageDescription =
  "قالیشویی زارع با سرویس دریافت و تحویل در نارمک، هفت‌حوض و میدان نبوت، خدمات شستشوی مکانیزه فرش، کارشناسی فرش دستبافت، رفع پارگی، شیرازه‌دوزی و رفوگری تخصصی را ارائه می‌دهد.";
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "بله. فرش‌های دستبافت پشمی، کرکی، گل‌ابریشم و تمام‌ابریشم پیش از شستشو از نظر ثبات رنگ، وضعیت بافت، ریشه، شیرازه و آسیب‌های احتمالی بررسی می‌شوند.",
  },
  {
    question:
