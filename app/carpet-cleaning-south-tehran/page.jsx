...
export const metadata = {
  ...
  description:
    'قالیشویی زارع با پوشش کامل در جنوب تهران مثل نازی‌آباد، شهرری، عبدل‌آباد، خزانه، شوش، کهریزک و سایر مناطق. خدمات حرفه‌ای شستشوی فرش با کیفیت تضمینی.',
  alternates: {
...
const schemaData = {
  ...
  description:
    'قالیشویی زارع با پوشش کامل در جنوب تهران شامل محله‌هایی مانند نازی‌آباد، یاخچی‌آباد، خزانه، شوش، دولت‌آباد، عبدل‌آباد، خانی‌آباد، علی‌آباد، شهرری، باقرشهر، مولوی و کهریزک، خدمات تخصصی شستشوی فرش و ترمیم را با کیفیت تضمینی ارائه می‌دهد.',
};
