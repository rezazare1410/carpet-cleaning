...
const pageTitle =
  "شستشوی تخصصی فرش دستبافت کرک و پشم | قالیشویی زارع";

const pageDescription =
  "فرش‌های دستبافت کرک و پشم پیش از شستشو از نظر ثبات رنگ، پوسیدگی، لکه و سلامت ریشه بررسی می‌شوند؛ با مراحل شستشو، آبگیری و مراقبت تخصصی از این فرش‌ها در کارخانه قالیشویی زارع آشنا شوید.";
...
const faqItems = [
  {
    question:
      "تفاوت شستشوی فرش دستبافت کرک و پشم چیست؟",
    answer:
  ...
  {
    question:
      "آیا فرش دستبافت پیش از شستشو آزمایش رنگ می‌شود؟",
    answer:
  ...
  {
    question:
      "آیا فرش دستبافت قدیمی و آسیب‌دیده قابل شستشو است؟",
    answer:
  ...
  {
    question:
      "آبگیری فرش دستبافت چگونه انجام می‌شود؟",
    answer:
  ...
  {
    question:
      "آیا لکه‌برداری فرش دستبافت همراه با شستشو انجام می‌شود؟",
    answer:
  ...
  {
    question:
      "قیمت شستشوی فرش دستبافت کرک و پشم چگونه محاسبه می‌شود؟",
    answer:
  ...
  {
    question:
      "چگونه سفارش شستشوی فرش دستبافت ثبت کنم؟",
    answer:
...
const schemaData = {
  ...
  "@graph": [
...

    {
      ...
      height: 851,
      caption:
        "شستشوی تخصصی فرش دستبافت کرک و پشم در کارخانه قالیشویی زارع",
    },

    {
      "@type": "Service",
      "@id": `${pageUrl}#service`,
      name: "شستشوی تخصصی فرش دستبافت کرک و پشم",
      serviceType:
        "کارشناسی، شستشو، لکه‌برداری و آبگیری فرش دستبافت کرک و پشم",
      url: pageUrl,
      description: pageDescription,
      image: {
        "@id": `${pageUrl}#primaryimage`,
