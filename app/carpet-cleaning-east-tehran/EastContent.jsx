...
const faqData = [
  ...
  },
  {
    ...
    text: "بله، نوع فرش، وضعیت رنگ، لکه‌ها و آسیب‌های احتمالی بررسی می‌شود تا روش مناسب شستشو یا ترمیم مشخص شود.",
  },
  {
    ...
    <main className="east-page">
      <section className="east-hero">
        <div className="east-hero-content">
          ...
          <h1 className="east-page-title">قالیشویی در شرق تهران</h1>

          <p className="east-hero-description">
            قالیشویی زارع خدمات دریافت، شستشو و تحویل انواع فرش ماشینی،
            دستباف و ابریشم را در محله‌های شرق تهران ارائه می‌دهد. روش
            شستشو بر اساس جنس، رنگ، بافت و وضعیت هر فرش انتخاب می‌شود تا
            آلودگی‌ها و لکه‌ها بدون استفاده از یک روش یکسان برای همه
            فرش‌ها برطرف شوند.
          </p>
          ...
          <div className="east-hero-buttons">
            ...
            <a href="tel:02177169450" className="east-secondary-button">
        ...
        <figure className="east-hero-image">
          ...
          <figcaption>
            شست‌وشوی تخصصی فرش با دستگاه اتوماتیک در کارخانه قالیشویی زارع
          </figcaption>
        </figure>
      </section>
      ...
      <section className="east-section east-intro-section">
        <div className="east-section-heading">
          ...
          <p>
            نوع شستشو باید با ساختار فرش متناسب باشد. به همین دلیل فرش‌های
            ماشینی، دستباف، پشمی و ابریشمی پیش از شستشو بررسی می‌شوند و
            خدمات لازم با توجه به وضعیت واقعی هر فرش مشخص می‌شود.
          </p>
        </div>

        <div className="east-services-grid">
          {services.map((service) => (
            <article key={service.title} className="east-service-card">
              <h3>{service.title}</h3>
              <p>{service.text}</p>
      ...
      <section className="east-section east-factory-services-section">
        <div className="east-section-heading">
          <h2>بخشی از خدمات تخصصی در کارخانه قالیشویی زارع</h2>
          <p>
            خدمات موردنیاز هر فرش پس از بررسی مشخص می‌شود. تصاویر زیر بخشی
            از مراحل واقعی ثبت سفارش، لکه‌برداری و اصلاح فرش در کارخانه
            قالیشویی زارع را نشان می‌دهند.
          </p>
        </div>
      ...
      <section className="east-section east-process-section">
        <div className="east-section-heading">
          ...
          <p>
            فرایند خدمات از زمان ثبت سفارش تا تحویل، به‌صورت مشخص و
            مرحله‌به‌مرحله انجام می‌شود.
          </p>
        </div>

        <ol className="east-process-list">
          {processSteps.map((step) => (
            <li key={step.number} className="east-process-card">
              <span className="east-step-number">{step.number}</span>
      ...
      <section className="east-section east-areas-section">
        <div className="east-section-heading">
          ...
          <p>
            سرویس جمع‌آوری و تحویل قالیشویی زارع در محله‌های مختلف شرق،
            شمال‌شرق و جنوب‌شرق تهران انجام می‌شود.
          </p>
        </div>
    ...
    <span key={area}>
      ...
      <section className="east-section east-quality-section">
        <div className="east-quality-content">
          <h2>چرا روش شستشوی همه فرش‌ها نباید یکسان باشد؟</h2>

          <p>
            فرش دستباف، ماشینی و ابریشم از نظر جنس الیاف، ثبات رنگ و نوع
            بافت با یکدیگر تفاوت دارند. استفاده از یک روش ثابت برای تمام
            فرش‌ها ممکن است نتیجه مناسبی نداشته باشد. به همین دلیل وضعیت
            رنگ، لکه‌ها، پوسیدگی و قسمت‌های آسیب‌دیده باید پیش از شروع کار
            بررسی شود.
          </p>

          <p>
            اگر فرش به لکه‌بری، رفو، شیرازه‌دوزی یا ترمیم نیاز داشته باشد،
            این موارد جدا از شستشوی معمولی ارزیابی می‌شوند. هدف این است که
            هر فرش متناسب با ویژگی‌های خودش شسته و آماده تحویل شود.
          </p>
        </div>
        ...
        <div className="east-guide-box">
          ...
          <p>
            در راهنمای انتخاب قالیشویی خوب، مهم‌ترین نکاتی را که پیش از
            ثبت سفارش باید بررسی کنید توضیح داده‌ایم.
          </p>
      ...
      <section className="east-section east-price-section">
        <div>
          ...
          <p>
            هزینه نهایی بر اساس نوع و ابعاد فرش، روش شستشو، میزان لکه‌ها و
            خدماتی مانند رفو یا ترمیم محاسبه می‌شود. برای مشاهده جزئیات،
            صفحه تعرفه خدمات قالیشویی را ببینید.
          </p>
        </div>

        <a href="/service-pricing" className="east-outline-button">
          مشاهده قیمت خدمات
        </a>
      </section>
      ...
      <section className="east-section east-faq-section">
        <div className="east-section-heading">
          ...
          <p>
            پاسخ پرسش‌های متداول درباره محدوده سرویس، زمان تحویل و نحوه
            شستشوی فرش‌ها را در ادامه می‌خوانید.
          </p>
        </div>

        <div className="east-faq-grid">
          {faqData.map((item) => (
            <article key={item.title} className="east-faq-card">
              <h3>{item.title}</h3>
              <p>{item.text}</p>
            </article>
          ))}
      ...
      <section className="east-final-cta">
        <div>
          ...
          <p>
            برای هماهنگی دریافت فرش، سفارش خود را آنلاین ثبت کنید یا با
            قالیشویی زارع تماس بگیرید.
          </p>
        </div>
        ...
        <div className="east-final-buttons">
          ...
          <a href="tel:02177169450" className="east-light-button">
            ۰۲۱-۷۷۱۶۹۴۵۰
          </a>
        </div>
      </section>
