...
export const metadata = {
  title: 'قالیشویی شرق تهران | شستشوی تخصصی فرش | زارع',
  description:
    'خدمات قالیشویی زارع در شرق، شمال‌شرق و جنوب‌شرق تهران؛ شستشوی تخصصی فرش ماشینی، دستباف و ابریشم همراه با لکه‌برداری، ترمیم و سرویس دریافت و تحویل.',
  keywords: [
    'قالیشویی شرق تهران',
