...
description:
  'قالیشویی زارع در شرق تهران با پوشش تهرانپارس، نارمک، حکیمیه، پیروزی و افسریه؛ شستشوی تخصصی فرش ماشینی، دستباف، گل‌ ابریشم همراه با لکه‌برداری، ترمیم و سرویس دریافت و تحویل.',
   keywords: [
    'قالیشویی شرق تهران',
