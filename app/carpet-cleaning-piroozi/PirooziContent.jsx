...
const trustCriteria = [
  ...
  },
  {
   ...
   text: "فرش ماشینی، دستبافت پشمی، کرک و گل‌ابریشم با یک روش ثابت شسته نمی‌شوند.",
  },
  {
    number: "۳",
...
export default function PirooziContent() {
  ...
  ماشینی، دستبافت پشمی، کرک و گل‌ابریشم را در خیابان
  ...
  توجه به جنس، رنگ، بافت و وضعیت هر فرش انتخاب می‌شود.
        ...
        <section className="piroozi-section piroozi-media-section piroozi-media-reverse">
          ...
          <div className="piroozi-media-content">
            ...
            <p>
  استفاده از یک روش ثابت برای فرش ماشینی، دستبافت پشمی،
  کرک و گل‌ابریشم ممکن است نتیجه مناسبی نداشته باشد؛ به
  همین دلیل روش کار برای هر فرش جداگانه انتخاب می‌شود.
</p>
