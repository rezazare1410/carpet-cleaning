...
export const metadata = {
  ...
  description:
    'قالیشویی زارع در غرب تهران: صادقیه، ستارخان، پونک، مرزداران، اکباتان، گیشا، شهران، جنت‌آباد، تهرانسر، آزادی، چیتگر. خدمات حرفه‌ای شستشوی فرش.',
  alternates: {
...
const schemaData = {
  ...
  description:
    'قالیشویی زارع با پوشش کامل در غرب تهران، در محله‌هایی مانند صادقیه، ستارخان، مرزداران، پونک، شهران، جنت‌آباد، تهرانسر، اکباتان، آزادی، گیشا و چیتگر، خدمات حرفه‌ای قالیشویی، لکه‌گیری و ریشه‌دوزی را با سرویس‌دهی سریع ارائه می‌دهد.',
};
